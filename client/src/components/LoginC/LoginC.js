      ...
      <div>
        <Paper className={classes.root} elevation={1} justify="center">
          ...
          <Grid container spacing={8}>
            ...
            <Grid item xs={12} sm={4} className={classes.buttonStyle}>
              <Button size="large" variant="contained"  color="primary" className={classes.button} href="/signup">
                New User
              </Button>
            </Grid>
          </Grid>
        ...
        >
          ...
          <DialogActions>
            <Button onClick={this.props.onClose} className={classes.button} color="primary" autoFocus>
              Close
            </Button> 
          </DialogActions>
        </Dialog>
